            ...
            <div class="col-12">
                ...
                <div class="padding-30-b ui-theme-base">
                    ...
                    <div class="form-lg ui-ease-1st-btn">
                        <button id="loadingBtn" class="ui-btn ui-btn-xs-fluid padding-25-h round ui-theme-sub ui-fill-dark-100 ui-ease-btn">Button</button>
                    </div>
                    ...
                    <div class="form-lg ui-ease-1st-btn">
                        <a href="#" class="loadingBtn ui-btn ui-btn-xs-fluid padding-25-h round ui-theme-sub ui-fill-dark-100">Link</a>
                        <button class="loadingBtn ui-btn ui-btn-xs-fluid padding-25-h round ui-theme-sub ui-fill-dark-100" onclick="alert('Javascript Alert');">Javascript Alert</button>
                    </div>
