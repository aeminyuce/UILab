        ...
        <div class="ui-row">
            <div class="ui-col-12">
                ...
                <div class="ui-padding-30-b ui-theme-base">
                    ...
                    <pre class="ui-round">ui.loadingMask.toggle(classname);<br><br>- or -<br><br>var variable = ui.find(element);<br>ui.loadingMask.toggle(variable);</pre>
                ...
                <div class="ui-padding-30-b ui-theme-base">
                    ...
                    <pre class="ui-round ui-margin-10-t ui-margin-5-b">ui.loadingMask.toggle('.loadingTextarea');</pre>
