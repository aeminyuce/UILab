        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="padding-30-b theme-default">
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('#loadingBtn');">Run Code</button>
                ...
                <div class="padding-30-b theme-default">
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('.loadingText1');">Run Code</button>
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('.loadingText2');">Run Code</button>
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('.loadingSelect');">Run Code</button>
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('.loadingTextarea');">Run Code</button>
                ...
                <div class="padding-30-b theme-default">
                    ...
                    <button class="btn btn-sm round ui-bg-dark-100 ease-btn" onclick="loadingMask.toggle('.loadingPage');">Run Code</button>
