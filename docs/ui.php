        ...
        <div class="row">
            <div class="col-12 ui-padding-30">
                ...
                <div class="ui-padding-30-v block-1st ui-theme-base">
                    ...
                    <pre class="round ui-margin-5-b">ui.on(element, event, function);<br>ui.on(element, event event ..., function);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Remove event listeners:</b>
                    <pre class="round ui-margin-5-b">ui.off(element, event);<br>ui.off(element, event event ...);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Add delegate event listeners:</b>
                    <pre class="round ui-margin-5-b">ui.on(parentElement, event, element, function);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Remove delegated event listeners:</b>
                    <pre class="round ui-margin-5-b">ui.off(parentElement, event);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Event naming:</b>
                    <pre class="round ui-margin-5-b">ui.on(element, event.eventname, function);<br>ui.on(element, event.eventname event.eventname ..., function);<br>ui.on(document, event.eventname, function);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Trigger event listeners:</b>
                    <pre class="round ui-margin-5-b">ui.trigger(element, event);<br>ui.trigger(element, event event ...);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Check classname:</b>
                    <pre class="round ui-margin-5-b">ui.hasClass(element, '.class');<br>ui.hasClass(element, '.class .class ...');</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Add classname:</b>
                    <pre class="round ui-margin-5-b">ui.addClass(element, '.class');<br>ui.addClass(element, '.class .class ...');</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Remove classname:</b>
                    <pre class="round ui-margin-5-b">ui.removeClass(element, '.class');<br>ui.removeClass(element, '.class .class ...');</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Toggle classname:</b>
                    <pre class="round ui-margin-5-b">ui.toggleClass(element, '.class');<br>ui.toggleClass(element, '.class .class ...');</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Show element:</b>
                    <pre class="round ui-margin-5-b">ui.show(element);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">Hide element:</b>
                    <pre class="round ui-margin-5-b">ui.hide(element);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">.each() Run for each matched element:</b>
                    <pre class="round ui-margin-5-b">ui.each(element, function);</pre>

                    <span class="sp-30"></span>

                    <b class="ui-margin-5-b">.closest() Returns the first ancestor:</b>
                    <pre class="round ui-margin-5-b">ui.closest(element, parentElement);</pre>
