                        ...
                        <div class="col-static sm-fluid">
                            <div class="row padding-20 form-lg">
                                ...
                                <div class="col-12 theme-default2">
                                    ...
                                    <button type="submit" class="signup-btn btn btn-md-fluid font-color-white circle hover-scale hover-shadow ease-btn">
                                        <b>SIGN UP NOW</b>
                                    </button>
                                    <span class="sp-30"></span>
                            ...
                            <div class="why-join col-lg-500 col-400 col-md-350 order-sm-first sm-align-c padding-30">
                                ...
                                <ul class="list-unstyled list-spacer-10 font-color-black-muted x-large icons-sm icons-margin-5-r theme-default2">
                                    <li>
