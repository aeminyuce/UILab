                        ...
                        <div class="carousel-slider ease-2nd-layout ease-layout ease-slow2x ease-in-out">
                            ...
                            <div class="slide-content padding-15 padding-30-b" data-animate="10">
                                <div class="card padding-15 shadow-lg">
                                    <div class="row row-lg-gap theme-gray ui-x-light full-h">
                                        <div class="col-4 col-md-3">
                                            <div class="row row-xs-gap ease-2nd-layout ease-slow ease-in-out">
                ...
                <div class="padding-30-b">
                    <div class="carousel-gallery card padding-15 round shadow-lg">
                        ...
                        <div id="detail-carousel2" class="thumbs">
                            <div class="row row-xs-gap no-fluid ease-2nd-layout">
                                <div class="col-5x">
