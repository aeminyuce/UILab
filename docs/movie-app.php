        ...
        <div class="col-200 set-relative hidden-md">
            <div class="sidebar col-200 full-h set-fixed set-l padding-5 ui-dark hidden-md scroll-v">
                ...
                <div class="align-l padding-10 icons-no-opacity icons-margin-10-r form-lg add-mobile-menu-l">
                    <h5 class="color-white-50 padding-15 margin-5-b">LIBRARY</h5>
                    ...
                    <h5 class="color-white-50 padding-15 margin-5-b">NEWS &amp; EVENTS</h5>
                    <ul class="list-unstyled list-spacer-15 color-white-50 large block-2nd ease-2nd-btn">
                        <li>
                            <a class="btn btn-ghost circle" href="#">
                ...
                <div class="padding-30 no-padding-b md-no-padding">
                    ...
                    <header class="row no-row-gap-t sticky-md icons-no-opacity form-lg" data-classes="shadow-lg">
                        ...
                        <div class="col-6 align-r">
                            <span class="align-c color-black-50 margin-20-r sm-no-margin ease-1st-btn">
                            ...
                            <span class="inline-block right no-float-sm">
                                ...
                                <span class="small color-black-50 block hidden-sm">Premium</span>
                            </span>
                        </div>
                    </header>
                    ...
                    <div class="carousel-slider block-2nd hover-scale-2nd ease-layout ease-2nd-layout ease-slow ease-in-out">
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <span class="color-black-50 margin-5-b block">2019 &nbsp; Action, Sci-Fi</span>
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    7,0 <span class="color-black-muted">/10</span> &nbsp; 7+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    8,7 <span class="color-black-muted">/10</span> &nbsp; 8+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <span class="color-black-50 margin-5-b block">2014 &nbsp; Action, Sci-Fi</span>
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    7,8 <span class="color-black-muted">/10</span> &nbsp; 13+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <span class="color-black-50 margin-5-b block">2015 &nbsp; Action, Comedy</span>
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    7,3 <span class="color-black-muted">/10</span> &nbsp; 13+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <span class="color-black-50 margin-5-b block">2018 &nbsp; Action, Thriller</span>
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    6,7 <span class="color-black-muted">/10</span> &nbsp; 15+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
                            <a class="ease-default" href="#">
                                ...
                                <span class="color-black-50 margin-5-b block">2017 &nbsp; Action, Fantasy</span>
                                <svg class="icon icon-xs color-yellow"><use href="#star-fill"/></svg>
                                <span class="inline-block margin-2-l margin-10-r">
                                    6,4 <span class="color-black-muted">/10</span> &nbsp; 13+
                                </span>
                            </a>
                        </div>
                        <div class="slide-content padding-15">
...
<div class="search modal form-lg">
    <div class="modal-container xs-no-padding">
        ...
        <form action="#successful">
            <h2>Search</h2>
            <p class="large color-white-50 xs-align-c">Search for movies, TV shows...</p>

            <div class="col-static no-fluid">
                <div class="row no-row-gap-h">
                    <div class="col-12 ease-1st-form">
                        <div class="text text-icon has-clear round-l no-border shadow-in-sm theme-gray ui-light ease-form">
                            <button type="button" class="clear-form">
                                <svg class="icon"><use href="#remove"/></svg>
                            </button>
            ...
            <div class="row no-fluid icons-xxl block-2nd icons-no-opacity icons-margin-5-v hover-t-more-2nd theme-default ease-2nd-btn">
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">1024</span>
                    </a>
                </div>
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">775</span>
                    </a>
                </div>
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">316</span>
                    </a>
                </div>
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">589</span>
                    </a>
                </div>
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">219</span>
                    </a>
                </div>
                <div class="col-4 padding-10-b">
                    <a class="btn btn-multi no-line-height round ui-dark" href="#">
                        ...
                        <span class="color-black-muted">701</span>
                    </a>
                </div>
            </div>
        </form>
