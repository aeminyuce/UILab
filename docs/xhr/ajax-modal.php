...
<div class="ui-modal-container ui-font-16 ui-p-30">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec tincidunt eros. Vivamus a est id dui ultricies congue vel et tellus. Nam ac velit mi. Donec vitae suscipit enim, nec consectetur nisl.
    <span class="ui-sp-10"></span>
        <div class="ui-color-black-50 ui-bold ui-m-5-b">Grid in Modal Example:</div>
        <div class="ui-row ui-no-fluid ui-m-5-b">
            <div class="ui-col-6">
                <div class="ui-border ui-p-5">ui-col-6</div>
            </div>
            <div class="ui-col-6">
                <div class="ui-border ui-p-5">ui-col-6</div>
            </div>
        </div>
        <div class="ui-color-black-50 ui-bold ui-m-5-b">Fixed Grid in Modal Example:</div>
        <div class="ui-fixed ui-m-10-b">
