...
<div class="ui-modal-footer">
    <div class="ui-modal-buttons ui-ease-1st-btn">
        <button type="button" class="ui-btn ui-padding-30-h ui-btn-ghost ui-border-dual circle" onclick="ui.modal.close(function () { alert('Modal closed!'); });">Callback</button>
        <button type="button" class="ui-btn ui-padding-30-h ui-btn-ghost ui-border-dual circle" onclick="ui.modal.close();">Cancel</button>
        <button type="submit" class="ui-btn ui-padding-30-h circle ui-theme-green ui-fill-dark-100" onclick="ui.modal.close();">Accept</button>
    </div>
</div>
