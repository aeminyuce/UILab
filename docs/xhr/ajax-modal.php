...
<div class="ui-modal-container large ui-padding-30">
    ...
    <img class="ui-img-fluid ui-margin-30-v ui-round ui-auto-margin ui-block shadow-lg" src="img/image_05.jpg" style="max-width: 700px" alt="">
...
<div class="ui-modal-footer">
    <div class="ui-modal-buttons ui-ease-1st-btn">
        <button type="button" class="ui-btn ui-padding-30-h ui-btn-ghost ui-border-dual ui-circle" onclick="ui.modal.close(function () { alert('Modal closed!'); });">Callback</button>
        <button type="button" class="ui-btn ui-padding-30-h ui-btn-ghost ui-border-dual ui-circle" onclick="ui.modal.close();">Cancel</button>
        <button type="submit" class="ui-btn ui-padding-30-h ui-circle ui-theme-green ui-fill-dark-100" onclick="ui.modal.close();">Accept</button>
    </div>
</div>
