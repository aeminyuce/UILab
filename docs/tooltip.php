        ...
        <div class="row ui-padding-30-v">
            ...
            <div class="col-12">
                ...
                <div class="ui-ease-1st-btn ui-theme-base ui-padding-30-b">
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" title="Tooltip <b>Top</b>">Tooltip <b>Top</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="b" title="Tooltip <u>Bottom</u>">Tooltip <b>Bottom</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="r" title="Tooltip <i>Right</i>">Tooltip <b>Right</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="l" title="Tooltip <em>Left</em>">Tooltip <b>Left</b></button>
                    <span class="sp-30"></span>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="tr" title="Tooltip <b>Top Right</b>">Tooltip <b>Top Right</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="tl" title="Tooltip <u>Top Left</u>">Tooltip <b>Top Left</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="br" title="Tooltip <i>Bottom Right</i>">Tooltip <b>Bottom Right</b></button>
                    <button class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="bl" title="Tooltip <em>Bottom Left</em>">Tooltip <b>Bottom Left</b></button>
                </div>

                <h3>Preventing Actions on Touch</h3>
                <div class="ui-theme-sub ui-ease-1st-btn ui-padding-30-b">
                    <a href="http://www.google.com/" target="_blank" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" title="Open link now!">Link</a>
                    <button onclick="alert('Test');" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" title="Run javascript aler now!">Javascript</button>
                </div>

                <h3>data-ui-only Attributes</h3>
                <div class="ui-theme-base ui-ease-1st-btn ui-padding-30-b">
                    <a href="http://www.google.com/" target="_blank" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" data-ui-only="mobile" title="Open link now!">Link (mobile)</a>
                    <a href="http://www.google.com/" target="_blank" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" data-ui-only="desktop" title="Open link now!">Link (desktop)</a>
                    <span class="sp-10"></span>
                    <button onclick="alert('Test');" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" data-ui-only="mobile" title="Run javascript aler now!">Javascript (mobile)</button>
                    <button onclick="alert('Test');" class="ui-btn ui-margin-5-b round ui-fill-dark-100" data-ui-tooltip="t" data-ui-only="desktop" title="Run javascript aler now!">Javascript (desktop)</button>
                </div>

                <h3>Using with Icons</h3>
                <div class="ui-theme-sub ui-icons-xl ui-color ui-padding-30-b hover-t-more-1st ui-ease-1st-layout">
