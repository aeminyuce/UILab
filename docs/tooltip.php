        ...
        <div class="row padding-30-v">
            ...
            <div class="col-12">
                ...
                <div class="ease-1st-btn theme-default padding-30-b">
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="t" title="Tooltip <b>Top</b>">Tooltip <b>Top</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="b" title="Tooltip <u>Bottom</u>">Tooltip <b>Bottom</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="r" title="Tooltip <i>Right</i>">Tooltip <b>Right</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="l" title="Tooltip <em>Left</em>">Tooltip <b>Left</b></button>
                    <span class="sp-30"></span>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="tr" title="Tooltip <b>Top Right</b>">Tooltip <b>Top Right</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="tl" title="Tooltip <u>Top Left</u>">Tooltip <b>Top Left</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="br" title="Tooltip <i>Bottom Right</i>">Tooltip <b>Bottom Right</b></button>
                    <button class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="bl" title="Tooltip <em>Bottom Left</em>">Tooltip <b>Bottom Left</b></button>
                </div>

                <h4>Preventing Actions on Touch</h4>
                <div class="theme-default2 ease-1st-btn padding-30-b">
                    <a href="http://www.google.com/" target="_blank" class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="t" title="Open link now!">Link</a>
                ...
                <div class="theme-default ease-1st-btn padding-30-b">
                    ...
                    <button onclick="alert('Test');" class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="t" data-ui-only="mobile" title="Run javascript aler now!">Javascript (mobile)</button>
                    <button onclick="alert('Test');" class="btn margin-5-b round ui-bg-dark-100" data-ui-tooltip="t" data-ui-only="desktop" title="Run javascript aler now!">Javascript (desktop)</button>
                </div>
