            ...
            <div class="ui-col-12 ui-p-30-v">
                                ...
                                <div class="ui-row ui-no-row-gap ui-no-fluid">
                                    ...
                                    <div class="ui-col-7">
                                        <ul class="ui-steps-bar ui-steps-icon ui-theme-red ui-text">
                                            ...
                                            <li class="ui-active">
                                                <svg class="ui-icon" data-ui-tooltip title="Waiting"><use href="img/icons.svg#clock"></svg>2:W
                                            </li>
                                            <li>
                                                <svg class="ui-icon" data-ui-tooltip title="Expert"><use href="img/icons.svg#check-circle"></svg>3:E
                                            </li>
                ...
                <div class="ui-datatable ui-datatable-hover ui-border ui-ease-datatable ui-round">
                    ...
                    <div class="ui-row ui-row-gap-xs ui-align-l ui-block-2nd ui-ease-2nd-btn ui-no-fluid">
                        <div class="ui-col-5">
                            <button class="ui-btn" data-ui-sort="1"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Name</button>
                        </div>
                        <div class="ui-col-3">
                            <button class="ui-btn" data-ui-sort="2" data-ui-type="number"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Age</button>
                        </div>
                        <div class="ui-col-4">
                            <button class="ui-btn" data-ui-sort="3"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Job</button>
                        </div>
                    </div>
                ...
                <div class="ui-datatable ui-datatable-striped ui-datatable-hover ui-border ui-ease-datatable ui-round">
                    ...
                    <div class="ui-row ui-sm-fluid">
                        ...
                        <div class="ui-col-7 ui-align-r ui-sm-align-l">
                            ...
                            <div class="ui-select ui-form-inline ui-round ui-border-dual ui-ease-form ui-float-r">
                                <svg class="ui-icon" data-ui-tooltip title="Waiting"><use href="img/icons.svg#angle-down"></svg>
                                <select class="ui-datatable-show">
                                    <option>10</option>
                                    <option>20</option>
                                    <option>50</option>
                    ...
                    <div class="ui-row ui-row-gap-xs ui-align-l ui-border-v ui-block-2nd ui-ease-2nd-btn ui-no-fluid">
                        <div class="ui-col-5">
                            <button class="ui-btn ui-btn-ghost" data-ui-sort="1"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Name</button>
                        </div>
                        <div class="ui-col-3">
                            <button class="ui-btn ui-btn-ghost" data-ui-sort="2" data-ui-type="number"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Age</button>
                        </div>
                        <div class="ui-col-4">
                            <button class="ui-btn ui-btn-ghost" data-ui-sort="3"><svg class="ui-icon"><use href="img/icons.svg#sort"></svg> Job</button>
                        </div>
                    </div>
