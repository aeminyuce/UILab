        ...
        <div class="sidebar col-250 set-relative visible-lg ui-theme-panel ui-ease-width ui-ease-in-out">
            <div class="col-250 full-h set-fixed set-l invert-bg ui-fill-dark-100 ui-ease-layout ui-ease-in-out">
                ...
                <div class="tabs align-l icons-no-opacity ui-theme-panel2 ui-ease-tabs ui-ease-1st-btn scroll-v scrollbar-faded add-mobile-menu-l" data-ui-classes="ui-color">
                    ...
                    <div class="ui-btn-list margin-10 icons-margin-10-r form-lg ui-ease-1st-btn">
                                    ...
                                    <div class="carousel-slider icons-margin-5-r ui-ease-layout ui-ease-slow ui-ease-in-out">
                                        ...
                                        <div class="slide-content padding-10-h padding-10-t padding-15-b ui-theme-yellow">
                                            <div class="ui-card full-h padding-15 round shadow-lg">
                                                ...
                                                <div class="progress-bar margin-15-t progress round">
                                                    <span class="ui-fill-dark-100 stripe-light" style="width: 45%;"></span>
                                                </div>
                                        ...
                                        <div class="slide-content padding-10-h padding-10-t padding-15-b ui-theme-yellow">
                                            <div class="ui-card full-h padding-15 round shadow-lg">
                                                ...
                                                <div class="progress-bar margin-15-t progress round">
                                                    <span class="ui-fill-dark-100 stripe-light" style="width: 5%;"></span>
                                                </div>
                                        ...
                                        <div class="slide-content padding-10-h padding-10-t padding-15-b ui-theme-green">
                                            <div class="ui-card full-h padding-15 round shadow-lg">
                                                ...
                                                <div class="progress-bar margin-15-t progress round">
                                                    <span class="ui-fill-dark-100 stripe-light" style="width: 80%;"></span>
                                                </div>
                                        ...
                                        <div class="slide-content padding-10-h padding-10-t padding-15-b ui-theme-panel2">
                                            <div class="ui-card full-h padding-15 round shadow-lg">
                                                ...
                                                <div class="progress-bar margin-15-t progress round">
                                                    <span class="ui-fill-dark-100 stripe-light" style="width: 67%;"></span>
                                                </div>
                                    ...
                                    <div class="grid-list grid-list-striped grid-hover ui-theme-gray ui-ease-grid-list">
                                        ...
                                        <div class="row no-row-gap no-fluid">
                                            ...
                                            <div class="col-8 align-r">
                                                <div class="grid-list-paging ui-pagination ui-ease-1st-btn" data-ui-default="ui-btn round" data-ui-active="ui-theme-panel2 ui-fill-dark-100"></div>
                                            </div>
                                        </div>
