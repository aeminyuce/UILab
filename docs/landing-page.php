                    ...
                    <div class="ui-row">
                        <div class="ui-col-12 ui-align-r">
                            ...
                            <div class="ui-hidden-sm">
                                <div class="ui-ease-1st-btn ui-icons-no-opacity ui-form-lg ui-add-sidebar-r">
                            ...
                            <button class="ui-btn ui-btn-lg ui-btn-square ui-btn-ghost ui-text ui-ease-btn ui-show-sidebar-r ui-visible-sm">
...
<main class="ui-container ui-no-gutter">
        ...
        <div class="ui-fixed ui-padding-10-t ui-theme-farmer2">
            <div class="ui-row ui-no-row-gap-v ui-icons-no-opacity ui-icons-margin-5-r">
                <div class="ui-col-12 ui-color-black-50 ui-xs-align-l ui-align-c ui-ease-1st-btn">
                    <button class="ui-tab ui-btn ui-btn-xs-fluid ui-btn-ghost ui-margin-1-b ui-border-b ui-text ui-border-lg ui-stroke active">
            ...
            <div class="ui-carousel-slider ui-icons-xxl ui-hover-shadow-2nd ui-hover-scale-2nd ui-ease-layout ui-ease-slow-2x ui-ease-in-out">
                ...
                <div class="ui-slide-content ui-padding-15">
                    <div class="ui-card ui-padding-15 ui-full-h ui-shadow-lg ui-ease-layout">
                        ...
                        <h3 class="ui-h3 ui-margin-10-b">Planting</h3>
                ...
                <div class="ui-slide-content ui-padding-15">
                    <div class="ui-card ui-padding-15 ui-full-h ui-shadow-lg ui-ease-layout">
                        ...
                        <span class="ui-sp-20"></span>
                        <h3 class="ui-h3 ui-margin-10-b">Garden Care</h3>
                ...
                <div class="ui-slide-content ui-padding-15">
                    <div class="ui-card ui-padding-15 ui-full-h ui-shadow-lg ui-ease-layout">
                        ...
                        <span class="ui-sp-20"></span>
                        <h3 class="ui-h3 ui-margin-10-b">Irrigation System</h3>
                ...
                <div class="ui-slide-content ui-padding-15">
                    <div class="ui-card ui-padding-15 ui-full-h ui-shadow-lg ui-ease-layout">
                        ...
                        <span class="ui-sp-20"></span>
                        <h3 class="ui-h3 ui-margin-10-b">Hardscaping</h3>
    ...
    <div class="ui-padding-30-v ui-theme-farmer ui-fill-light-100">
        <div class="ui-fixed ui-margin-30-b">
            <div class="ui-row">
                <div class="ui-col-12">
                    <h2 class="ui-h2 ui-font-bold ui-margin-10-b">News</h2>
                    <h3 class="ui-h3 ui-text">Follow our activities.</h3>
                </div>
            </div>
        </div>
        <div class="ui-tabs ui-form-lg ui-border-t ui-padding-10-t ui-ease-tabs" data-ui-classes="ui-text ui-border-lg ui-stroke">
    ...
    <div class="ui-fixed ui-theme-farmer2">
        <div class="ui-row">
            <div class="ui-col-12">
                <h2 class="ui-h2 ui-font-bold ui-margin-10-b">Our Projects</h2>
                <h3 class="ui-h3 ui-text ui-margin-25-b">What we are doing?</h3>
                        ...
                        <a class="ui-photo ui-has-info ui-show-info" href="img/agriculture/md01.jpg">
                            ...
                            <span class="ui-font-18 ui-font-readable">
                                <span class="ui-scroll-v ui-margin-20 ui-set-absolute ui-set-all">
                                    <svg class="ui-icon ui-icon-xxl ui-left ui-margin-20-r ui-hidden-md ui-text"><use href="#trees"/></svg>
    ...
    <div class="ui-padding-15-t ui-padding-30-b ui-theme-farmer ui-fill-light-100">
        <div class="ui-fixed ui-padding-30-v">
            <div class="ui-row">
                <div class="ui-col-12">
                    <h2 class="ui-h2 ui-font-bold ui-margin-10-b">Why Choose Us</h2>
                    <h3 class="ui-h3 ui-text ui-margin-25-b">See detailed statistics.</h3>
                </div>
                <div class="ui-col-static">
                    <div class="ui-row">
                        <div class="ui-col-12">
                    ...
                    <div class="ui-col-500 ui-padding-10 ui-xs-align-c">
                        <p class="ui-color-black-50 ui-font-readable ui-font-18 ui-margin-30-b">
                            <span class="ui-sp-15"></span>
    ...
    <div class="ui-fixed ui-padding-30-v ui-sm-align-c">
        <div class="ui-row">
            <div class="ui-col-static">
                <div class="ui-row ui-sm-fluid">
                    <div class="ui-col-4">
                        <h4 class="ui-h4 ui-color-white-50 ui-margin-30-b">Customer Service</h4>
                    ...
                    <div class="ui-col-4">
                        <h4 class="ui-h4 ui-color-white-50 ui-margin-30-b">Who We Are</h4>
                        <ul class="ui-list-unstyled ui-list-spacer-10 ui-font-hoverline-2nd ui-font-18">
                    ...
                    <div class="ui-col-4">
                        <h4 class="ui-h4 ui-color-white-50 ui-margin-30-b">Quick Links</h4>
                        <ul class="ui-list-unstyled ui-list-spacer-10 ui-font-hoverline-2nd ui-font-18">
                ...
                <div class="ui-col-500 ui-padding-10">
                    ...
                    <div class="footer-social ui-padding-15 ui-icons-no-opacity">
                        <div class="ui-card ui-padding-30 ui-shadow-lg ui-theme-farmer ui-fill-dark-100">
                            ...
                            <h4 class="ui-h4 ui-margin-15-b">Sign Up for Email</h4>
...
<div class="ui-sidebar ui-show-r ui-ease-layout ui-ease-in-out">
    <div class="ui-sidebar-title ui-border-b">
        <button class="ui-btn ui-btn-square ui-btn-lg ui-btn-ghost ui-ease-btn ui-close-sidebar">
