                    ...
                    <div class="ui-row ui-row-gap-lg ui-xs-fluid ui-form-lg">
                        <div class="ui-col-4 ui-col-sm-6">
                            ...
                            <div class="ui-card ui-p-30 ui-round ui-shadow-lg">
                                <span class="ui-photo-slider ui-m-15-b">
                                    ...
                                    >
                                    <button title="Prev" class="ui-prev ui-btn ui-btn-ghost ui-btn-square ui-m-15-l ui-circle ui-ease-btn">
                                        <svg class="ui-icon ui-m-3-r"><use href="#angle-left"/></svg>
                                    </button>
                                    <button title="Next" class="ui-next ui-btn ui-btn-ghost ui-btn-square ui-m-15-r ui-circle ui-ease-btn">
                                        <svg class="ui-icon ui-m-3-l"><use href="#angle-right"/></svg>
                                    </button>
                                    <span class="ui-photo-slider-nav ui-m-15-b ui-ease-1st-layout"></span>
                                </span>
                                <span class="ui-font-18">Canvas Photo Series #101</span>
                                <span class="ui-color-black-50 ui-block ui-m-10-v">Lorem ipsum dolor sit amet.</span>
