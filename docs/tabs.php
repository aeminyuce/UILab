    ...
    <div class="fixed">
        <div class="row">
            <div class="col-12 padding-30">
                ...
                <div class="ui-tabs padding-30-b ui-theme-sub ui-ease-tabs" data-ui-classes="ui-border-lg ui-stroke ui-color">
                ...
                <div class="ui-tabs padding-30-b ui-theme-sub ui-ease-tabs" data-ui-classes="ui-stroke ui-color">

                    <div class="ui-btn-holder font-color-black-muted margin-10-b form-lg ui-ease-1st-btn">
                        <button class="ui-tab ui-btn ui-btn-ghost ui-border-b round-t ui-stroke ui-color ui-active">Tab Button</button>
                ...
                <h3>ui-tabs with Toggle</h3>
                <div class="ui-tabs padding-30-b ui-ease-tabs" data-ui-classes="ui-stroke ui-color ui-border-lg">
                ...
                <div class="ui-tabs col-static ui-border-dual margin-30-b ui-ease-tabs" data-ui-classes="ui-border-lg ui-stroke ui-color">
                ...
                <h3>Inner ui-tabs</h3>
                <div class="ui-tabs padding-30-b ui-ease-tabs" data-ui-classes="ui-border-lg ui-stroke ui-color">

                    <div class="md-align-c ui-theme-sub form-lg ui-ease-1st-btn">
                        <button class="ui-tab ui-btn ui-btn-ghost ui-border-b ui-border-lg ui-stroke ui-color ui-active">Tab Button</button>
                        <button class="ui-tab ui-btn ui-btn-ghost ui-border-b">Tab Button</button>
                    </div>

                    <div class="ui-tab-content ui-tabs col-static ui-border-dual margin-30-b ui-ease-tabs open open-ease" data-ui-classes="ui-border-lg ui-stroke ui-color">
                    ...
                    <div class="ui-tab-content ui-tabs col-static ui-border-dual margin-30-b ui-ease-tabs" data-ui-classes="ui-border-lg ui-stroke ui-color">
                ...
                <h3>ui-tabs with ID</h3>
                <div class="ui-tabs padding-30-b form-lg ui-theme-sub ui-ease-tabs">
                ...
                <div class="ui-tabs padding-30-b form-lg ui-theme-sub ui-ease-tabs" data-ui-classes="ui-fill-dark-100">

                    <button class="ui-tab ui-tab-toggle ui-btn block align-l margin-1-b round ui-ease-btn">
                ...
                <h3>Inner Accordion ui-tabs</h3>
                <div class="ui-tabs padding-30-b form-lg ui-theme-sub ui-ease-tabs" data-ui-classes="ui-fill-dark-100">

                    <button class="ui-tab ui-tab-toggle ui-btn block align-l margin-1-b ui-ease-btn">
                        <svg class="ui-toggle-icon ui-icon right"><use href="#angle-down"/></svg>
                        Tab Button
                    </button>
                    <div class="ui-tab-content">

                        <div class="ui-tabs ui-icons-xs" data-ui-classes="ui-color">
                            <button class="ui-tab ui-tab-toggle ui-btn-ghost ui-btn align-l block ui-ease-btn">
                ...
                <div class="ui-tabs ui-icons-no-opacity padding-30-b ui-ease-tabs" data-ui-classes="ui-color ui-icons-default">
