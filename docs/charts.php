    ...
    <div class="fixed">
        <div class="row">
            <div class="col-12 padding-30-v">
                ...
                <div class="row row-gap-lg-v">
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines">
                                <li data-ui-y="84"></li>
                                <li data-ui-y="56"></li>
                                <li data-ui-y="112"></li>
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines" data-ui-type="curved">
                                <li data-ui-y="0"></li>
                                <li data-ui-y="-56"></li>
                                <li data-ui-y="-112"></li>
                                <li data-ui-y="-140"></li>
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines" data-ui-type="dotted">
                                <li data-ui-y="0"></li>
                                <li data-ui-y="-56"></li>
                                <li data-ui-y="-112"></li>
                                <li data-ui-y="-140"></li>
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines" data-ui-type="dashed">
                                <li data-ui-y="0"></li>
                                <li data-ui-y="-56"></li>
                                <li data-ui-y="-112"></li>
                                <li data-ui-y="-140"></li>
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines" data-ui-name="1st">
                            ...
                            <ul class="lines" data-ui-name="2nd">
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            ...
                            <ul class="lines" data-ui-name="2nd" data-ui-type="curved">
                                <li data-ui-y="120" data-ui-link="#1"></li>
                                <li data-ui-y="20" data-ui-link="#2"></li>
                                <li data-ui-y="159" data-ui-link="#3"></li>
                                <li data-ui-y="120" data-ui-link="#4"></li>
                            ...
                            <ul class="lines" data-ui-name="3rd" data-ui-type="curved">
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            <ul class="lines" data-ui-name="1st" data-ui-type="filled">
                                <li data-ui-y="-34" data-ui-link="#1"></li>
                                <li data-ui-y="-56" data-ui-link="#2"></li>
                                <li data-ui-y="-112" data-ui-link="#3"></li>
                                <li data-ui-y="-140" data-ui-link="#4"></li>
                            ...
                            <ul class="lines" data-ui-name="2nd" data-ui-type="filled">
                                <li data-ui-y="120" data-ui-link="#1"></li>
                                <li data-ui-y="20" data-ui-link="#2"></li>
                                <li data-ui-y="159" data-ui-link="#3"></li>
                                <li data-ui-y="120" data-ui-link="#4"></li>
                    ...
                    <div class="col-6">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                            ...
                            <ul class="lines" data-ui-name="3rd" data-ui-type="curved filled">
                                <li data-ui-y="32" data-ui-link="#1"></li>
                                <li data-ui-y="52" data-ui-link="#2"></li>
                                <li data-ui-y="117" data-ui-link="#3"></li>
                                <li data-ui-y="85" data-ui-link="#4"></li>
                    ...
                    <div class="col-12 theme-default ui-fill-dark-100 round">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="font-bold align-c">Filled Line Charts</h5>
                                <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-x="Mon,Tue,Wed,Thu,Fri,Sat,Sun">
                    ...
                    <div class="col-12">
                        ...
                        <div class="line-charts ease-line-charts" data-ui-size="10,25" data-ui-step="6"
                            ...
                            <ul class="lines" data-ui-type="filled dotted">
                                <li data-ui-y="84"></li>
                                <li data-ui-y="56"></li>
                                <li data-ui-y="112"></li>
                                <li data-ui-y="140"></li>
            ...
            <div class="col-lg-8 push-lg-2 col-12 padding-30-v">
                ...
                <div class="padding-10-v align-c lg-align-l xs-align-c">
                ...
                <div class="row row-gap-lg-v theme-default ui-fill-dark-100 round">
                    <div class="col-3 col-xs-6">
                        <div class="donut-chart ease-donut-chart">
                            <strong>HTML</strong>
                            <svg viewBox="0 0 160 160">
