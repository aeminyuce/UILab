                ...
                <div class="ui-row ui-row-gap-lg ui-align-c">
                    <div class="ui-col-4">
                        ...
                        <div class="ui-card ui-full-h ui-p-30 ui-round ui-shadow">
                            <div class="ui-m-30-v">
                                <svg class="ui-icon pricing-table-icon ui-theme-sub ui-text"><use href="../dist/icons.svg#box"/></svg>
                            </div>
                            ...
                            <a class="ui-btn ui-btn-lg ui-btn-xs-fluid ui-m-30-b ui-circle ui-shadow-lg ui-theme-green ui-fill-dark-100 ui-ease-btn" href="#">
                                ...
                                <svg class="ui-icon ui-m-5-l"><use href="../dist/icons.svg#heart"/></svg>
                            </a>
                        </div>

                    </div>
                    <div class="ui-col-4 ui-no-p-v">

                        <div class="ui-card ui-full-h ui-p-30 ui-round ui-shadow-lg ui-theme-sub ui-fill-dark-100">
                            <div class="ui-m-30-v">
                                <svg class="ui-icon pricing-table-icon"><use href="../dist/icons.svg#gift"/></svg>
                            </div>
                            <h2 class="ui-h2 ui-font-bold ui-m-15-v">$19</h2>
                            <h4 class="ui-h4">Business License</h4>
                            <p class="ui-color-white-50 ui-font-16 ui-font-readable ui-m-30-v">Lorem ipsum dolor sit amet edipiscing elit sed do eiusmod elpors labore et dolore magna siad enim aliqua.</p>
                            ...
                            <a class="ui-btn ui-btn-multi ui-btn-lg ui-btn-xs-fluid ui-circle ui-shadow-lg ui-theme-base ui-fill-dark-200 ui-ease-btn" href="#">
                                ...
                                <svg class="ui-icon ui-m-5-l"><use href="../dist/icons.svg#shopping-cart"/></svg>
                            </a>
                            <div class="ui-color-white-50 ui-m-30-v">
                                <svg class="ui-icon ui-m-5-r"><use href="../dist/icons.svg#check-badge"/></svg>Recommend
                            </div>
                        </div>
                    ...
                    <div class="ui-col-4">
                        ...
                        <div class="ui-card ui-full-h ui-p-30 ui-round ui-shadow">
                            <div class="ui-m-30-v">
                                <svg class="ui-icon pricing-table-icon ui-theme-sub ui-text"><use href="../dist/icons.svg#wallet"/></svg>
                            </div>
                            ...
                            <a class="ui-btn ui-btn-lg ui-btn-xs-fluid ui-m-30-b ui-circle ui-shadow-lg ui-theme-sub ui-fill-dark-100 ui-ease-btn" href="#">
                                <b class="ui-inline-block">PURCHASE</b>
                                <svg class="ui-icon ui-m-5-l"><use href="../dist/icons.svg#shopping-basket"/></svg>
                            </a>
                        </div>
                            ...
                            <div class="ui-card-side ui-p-30">
                                <ul class="ui-list-unstyled ui-list-sp-15 ui-m-15-v ui-font-16 ui-block-2nd">
                                    ...
                                    <li>
                                        ...
                                        <svg class="ui-icon"><use href="../dist/icons.svg#check"/></svg>
                                    </li>
                                    <li>
