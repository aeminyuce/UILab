    ...
    <div class="ui-fixed">
        <div class="ui-row">
            <div class="ui-col-12 ui-p-30">
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-list-col-2 ui-ease-list-group">
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-list-col-3 ui-ease-list-group">
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-list-col-4 ui-ease-list-group">
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Sed finibus rhoncus.</li>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-ease-list-group ui-icons-m-5-r">
                        <li>
                            ...
                            <b>İstanbul: </b>
                            <a class="ui-list-url ui-font-underline" href="#">
                                Show Directions
                                <svg class="ui-icon ui-icon-xs ui-m-3-l"><use href="#long-arrow-right"></use></svg>
                            </a>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-has-avatar-xs ui-has-icon-xs ui-ease-list-group">
                        <li>
                            <a href="#">
                                <svg class="ui-list-icon ui-icon"><use href="#angle-right"/></svg>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-has-avatar-sm ui-has-icon-sm ui-ease-list-group">
                        <li>
                            <a href="#">
                                <svg class="ui-list-icon ui-icon"><use href="#angle-right"/></svg>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-has-avatar ui-has-icon ui-ease-list-group">
                        <li>
                            <a href="#">
                                <svg class="ui-list-icon ui-icon"><use href="#angle-right"/></svg>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-has-avatar-lg ui-has-icon-lg ui-ease-list-group">
                        <li>
                            <a href="#">
                                <svg class="ui-list-icon ui-icon"><use href="#angle-right"/></svg>
                ...
                <div class="ui-list-group ui-border ui-round">
                    <ul class="ui-has-avatar ui-has-icon-sm ui-ease-list-group">
                        <li>
