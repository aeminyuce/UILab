            ...
            <div class="col-12 no-padding-v">
                <div class="row lg-fluid">
                    ...
                    <div class="col-6">
                        ...
                        <!-- employee list -->
                        <div class="grid-list grid-striped grid-hover card full-h round shadow-lg theme-gray ease-grid-list">
                            ...
                            <div class="grid-container icons-xxs">

                                <div class="grid-content no-border" data-ui-val="John Doe|25|Designer">
                                ...
                                <div class="grid-content no-border" data-ui-val="Mary Doe|24|Designer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                ...
                                <div class="grid-content no-border" data-ui-val="Mike Taylor|29|Developer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                ...
                                <div class="grid-content no-border" data-ui-val="Bob Pool|25|Designer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                ...
                                <div class="grid-content no-border" data-ui-val="John Doe|24|Designer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">John Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Mary Doe|24|Researcher">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image2.jpg" alt="">Mary Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="John Doe|25|Developer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">John Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Mary Doe|24|Developer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image2.jpg" alt="">Mary Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Bob Pool|25|Researcher">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image3.jpg" alt="">Bob Pool
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="John Doe|25|Researcher">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">John Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Bob Pool|25|Developer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image3.jpg" alt="">Bob Pool
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="John Doe|24|Developer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">John Doe
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Mike Taylor|29|Designer">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">Mike Taylor
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="Mike Taylor|29|Researcher">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">Mike Taylor
                                        </div>
                                ...
                                <div class="grid-content no-border" data-ui-val="John Doe|24|Researcher">
                                    <div class="row no-row-gap no-fluid">
                                        <div class="col-5">
                                            <img class="img-photo-sm margin-10-r hidden-xs circle" src="img/profile-image.jpg" alt="">John Doe
                                        </div>
