            ...
            <div class="ui-col-12 ui-p-30">
                ...
                <div class="ui-row ui-xs-fluid ui-align-l ui-p-30-b ui-block-2nd ui-ease-2nd-btn">
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-ghost ui-btn-lg ui-circle ui-border" href="#">
                            Large Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#settings"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-ghost ui-btn-lg ui-circle ui-border" href="#">
                    ...
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-ghost ui-circle ui-border" href="#">
                            Default Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#settings"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-ghost ui-btn-sm ui-circle ui-border" href="#">
                            Small Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#settings"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-ghost ui-btn-xs ui-circle ui-border" href="#">
                            Extra Small Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#settings"/></svg>
                        </a>
                    </div>
                    ...
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-lg ui-round" href="#">
                            Large Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#comment"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-lg ui-round" href="#">
                    ...
                    <div class="ui-col-6">
                        <a class="ui-btn ui-round" href="#">
                            Default Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#comment"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-sm ui-round" href="#">
                            Small Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#comment"/></svg>
                        </a>
                    </div>
                    <div class="ui-col-6">
                        <a class="ui-btn ui-btn-xs ui-round" href="#">
                            Extra Small Button <svg class="ui-icon ui-float-r"><use href="img/icons.svg#comment"/></svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="ui-p-30-b ui-theme-sub ui-ease-1st-btn">
                    <a class="ui-btn ui-btn-square ui-btn-xs ui-round ui-fill-dark-100" href="#">
                        <svg class="ui-icon"><use href="img/icons.svg#trash"/></svg>
                    </a>
                ...
                <div class="ui-p-30-b ui-form-lg ui-ease-1st-btn">
                    <a class="ui-btn ui-btn-square ui-round ui-btn-xs-fluid" href="#">
                        <svg class="ui-icon"><use href="img/icons.svg#filter"/></svg>
                    </a>
                ...
                <div class="ui-p-30-b">
                    ...
                    <div class="ui-paging ui-align-c ui-theme-sub ui-ease-1st-btn">
                        <a class="ui-btn ui-btn-xs ui-paging-prev ui-round" href="#">
                            <svg class="ui-icon"><use href="img/icons.svg#angle-dual-left"/></svg>
                        </a>
                        <a class="ui-btn ui-btn-xs ui-paging-prev ui-round" href="#">
                            <svg class="ui-icon"><use href="img/icons.svg#angle-left"/></svg>
                        </a>
                        ...
                        <a class="ui-btn ui-btn-xs ui-paging-next ui-round" href="#">
                            <svg class="ui-icon"><use href="img/icons.svg#angle-right"/></svg>
                        </a>
                        <a class="ui-btn ui-btn-xs ui-paging-next ui-round" href="#">
                            <svg class="ui-icon"><use href="img/icons.svg#angle-dual-right"/></svg>
                        </a>
                    </div>
                ...
                <div class="ui-row ui-p-30-b">
                    <div class="ui-col-6">
                        <div class="ui-btn-list ui-align-l ui-icons-m-10-r ui-form-lg ui-icons-no-opacity ui-theme-green ui-ease-1st-btn">
                            <button class="ui-btn">
                                <svg class="ui-icon ui-text"><use href="img/icons.svg#shield"/></svg>Administration
                            </button>
                            <button class="ui-btn">
                                <svg class="ui-icon ui-text"><use href="img/icons.svg#clock"/></svg>Recent History
                            </button>
                            <button class="ui-btn">
                                <svg class="ui-icon ui-text"><use href="img/icons.svg#settings"/></svg>Tools
                            </button>
                        </div>
                    </div>
                    <div class="ui-col-6">
