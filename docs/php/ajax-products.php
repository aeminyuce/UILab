    ...
    <a class="full-height padding-15 no-padding-t portlet rounded shadow-lg hover-shadow hover-up ease-layout" href="#">
        <span class="photo-slider margin-20-b">
            ...
            <button title="Prev" class="slide-left rounded ease-layout">
                <i class="icon icon-md icon-angle-left"></i>
            </button>
            <button title="Next" class="slide-right rounded ease-layout">
                <i class="icon icon-md icon-angle-right"></i>
            </button>
...
<div class="col-4 col-sm-6 xs-responsive">
    <a class="full-height padding-15 no-padding-t portlet rounded shadow-lg hover-shadow hover-up ease-layout" href="#">
        <span class="photo-slider margin-20-b">
            <i class="slider-loader icon icon-xl icon-loader"></i>
            <img src="img/product_blank.gif"
                    data-src="img/product_04.png"
                    data-srcset="img/product_04@2x.png"
                alt="">
            <button title="Prev" class="slide-left rounded ease-layout">
                <i class="icon icon-md icon-angle-left"></i>
            </button>
...
<div class="col-4 col-sm-6 xs-responsive">
    <a class="full-height padding-15 no-padding-t portlet rounded shadow-lg hover-shadow hover-up ease-layout" href="#">
        <span class="photo-slider margin-20-b">
            <i class="slider-loader icon icon-xl icon-loader"></i>
            <img src="img/product_blank.gif"
                    data-src="img/product_05.png"
                    data-srcset="img/product_05@2x.png"
                alt="">
            <button title="Prev" class="slide-left rounded ease-layout">
                <i class="icon icon-md icon-angle-left"></i>
            </button>
