    ...
    <div class="ui-fixed ui-p-30-v ui-theme-base">
        <div class="ui-row">
            ...
            <div class="ui-col-12">
                ...
                <pre class="ui-pre ui-ease-pre ui-round">ui.alerts.dialog({ msg: '', success: '', error: '', custom: { value: 'button text', value: 'button text' }, callback });</pre>
            ...
            <div class="ui-col-12 ui-p-30-b">
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.dialog({<br>    msg: 'Your dialog example.'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.dialog({<br>    msg: 'Your dialog example.',<br>    success: 'Got it!'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.dialog({<br>    msg: 'Your dialog example.',<br>    success: 'Got it!',<br>    error: 'No, thanks!'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.dialog({<br>    msg: 'Your dialog example.',<br>    success: 'Got it!',<br>    error: 'No, thanks!',<br>    custom: {<br>        maybe: 'Maybe', later: 'Later'<br>    }<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.dialog({<br>    msg: 'Your dialog example.',<br>    success: 'Got it!',<br>    error: 'No, thanks!',<br>    custom: {<br>        maybe: 'Maybe', later: 'Later'<br>    },<br>    callback: function (value) {<br>        alert(value);<br>    }<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">return ui.alerts.dialog({<br>    msg: 'Submit this form?',<br>    success: 'Yes',<br>    error: 'No',<br>    callback: function (value) {<br>        if (value === 'success') {<br>            document.getElementById('exampleForm').submit();<br>        }<br>    }<br>});</pre>
            ...
            <div class="ui-col-12">
                ...
                <pre class="ui-pre ui-ease-pre ui-round">ui.alerts.message({ msg: '', pos: '', theme: '' });</pre>
            ...
            <div class="ui-col-6">
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Bottom left message',<br>    pos: 'bl'<br>});</pre>
            ...
            <div class="ui-col-6">
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Top right message',<br>    pos: 'tr'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Bottom right message',<br>    pos: 'br'<br>});</pre>
            ...
            <div class="ui-col-12">
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Default message'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Success message',<br>    theme: 'success'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg:'Warning message',<br>    theme: 'warning'<br>});</pre>
                ...
                <pre class="ui-pre ui-ease-pre ui-round ui-m-5-b">ui.alerts.message({<br>    msg: 'Danger message',<br>    theme: 'danger'<br>});</pre>
