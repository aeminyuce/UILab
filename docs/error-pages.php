        ...
        <div class="row">
            <div class="col-12 padding-30-v">
                ...
                <div class="align-c form-lg">
                    <p class="color-red largest font-bold">Error: 404 Page Not Found</p>
                    <p class="color-red error-size no-user-select">
                ...
                <div class="align-c form-lg">
                    <p class="color-yellow largest font-bold">Error: 403 Forbidden</p>
                    <p class="color-yellow error-size no-user-select">
                        <span class="inline-block">4</span>
                    ...
                    <a class="color-yellow btn btn-ghost border-dual padding-30-h circle ease-btn" href="#">
                ...
                <div class="align-c form-lg">
                    <p class="color-orange largest font-bold">Error: 500 Unexpected Error</p>
                    <p class="color-orange error-size no-user-select">
                    ...
                    <a class="color-orange btn btn-ghost border-dual padding-30-h circle ease-btn" href="#">
                        <svg class="icon margin-5-r no-opacity"><use href="#long-arrow-left"/></svg>
                        Go Back
                    </a>
                </div>
