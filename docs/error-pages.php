        ...
        <div class="ui-row">
            <div class="ui-col-12 ui-padding-30-v">
                ...
                <div class="align-c form-lg">
                    ...
                    <p class="highlight ui-color-red error-size no-user-select">
                ...
                <div class="align-c form-lg">
                    ...
                    <p class="highlight ui-color-yellow error-size no-user-select">
                        <span class="inline-block">4</span>
                ...
                <div class="align-c form-lg">
                    ...
                    <p class="highlight ui-color-orange error-size no-user-select">
