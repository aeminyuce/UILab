            ...
            <div class="ui-col-12 ui-p-30-v">
                ...
                <div class="ui-align-c ui-form-lg">
                    ...
                    <p class="ui-highlight ui-color-red error-pages-icon ui-no-selection">
                        ...
                        <svg class="ui-icon"><use href="img/icons.svg#undo"/></svg>
                        <span class="ui-inline-block">4</span>
                    </p>
                ...
                <div class="ui-align-c ui-form-lg">
                    ...
                    <a class="ui-color-yellow ui-btn ui-btn-ghost ui-border-dual ui-circle ui-ease-btn" href="#">
                        <svg class="ui-icon ui-m-5-r ui-no-opacity"><use href="img/icons.svg#long-arrow-left"/></svg>
                        Go Back
                    </a>
                </div>
                ...
                <div class="ui-align-c ui-form-lg">
                    ...
                    <p class="ui-highlight ui-color-orange error-pages-icon ui-no-selection">
                        ...
                        <svg class="ui-icon"><use href="img/icons.svg#face-blank"/></svg>
                        <svg class="ui-icon"><use href="img/icons.svg#face-blank"/></svg>
                    </p>
