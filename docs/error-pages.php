<!-- custom CSS -->
<link rel="stylesheet" href="../css/custom/error-pages.css?v=<?php echo filemtime('../css/custom/error-pages.css'); ?>"/>
        ...
        <div class="ui-row">
            <div class="ui-col-12 ui-padding-30-v">
                ...
                <div class="align-c form-lg">
                    <p class="highlight ui-color-red largest font-bold">Error: 404 Page Not Found</p>
                    <p class="highlight ui-color-red error-size ui-no-user-select">
                ...
                <div class="align-c form-lg">
                    <p class="highlight ui-color-yellow largest font-bold">Error: 403 Forbidden</p>
                    <p class="highlight ui-color-yellow error-size ui-no-user-select">
                        <span class="inline-block">4</span>
                        <svg class="ui-icon"><use href="#ban"/></svg>
                        <span class="inline-block">3</span>
                    </p>
                    <p class="highlight x-large font-readable">You don't have access to this page.<br>Please contact support if this wasn't supposed to happen.</p>
                ...
                <div class="align-c form-lg">
                    <p class="highlight ui-color-orange largest font-bold">Error: 500 Unexpected Error</p>
                    <p class="highlight ui-color-orange error-size ui-no-user-select">
                        <span class="inline-block">5</span>
                        <svg class="ui-icon"><use href="#face-blank"/></svg>
                        <svg class="ui-icon"><use href="#face-blank"/></svg>
                    </p>
                    <p class="highlight x-large font-readable">We are having some issues at the moment.<br>We will have it fixed in no time!</p>
