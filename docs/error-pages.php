            ...
            <div class="col-12 padding-30-v">
                ...
                <div class="align-c form-lg">
                    ...
                    <ul class="font-color-red list-unstyled list-spacer-10 ui-ease-2nd-btn">
                        <li><a class="btn btn-ghost circle ui-border-dual" href="#">Home</a class="ui-color"></li>
                        <li><a class="btn btn-ghost circle ui-border-dual" href="#">Help Center</a></li>
                        <li><a class="btn btn-ghost circle ui-border-dual" href="#">Sign In</a></li>
                    </ul>
                </div>
                ...
                <div class="align-c form-lg">
                    ...
                    <a class="font-color-yellow btn btn-ghost ui-border-dual padding-30-h circle ui-ease-btn" href="#">
                ...
                <div class="align-c form-lg">
                    ...
                    <a class="font-color-orange btn btn-ghost ui-border-dual padding-30-h circle ui-ease-btn" href="#">
                        <svg class="icon margin-5-r no-opacity"><use href="#long-arrow-left"/></svg>
                        Go Back
                    </a>
                </div>
