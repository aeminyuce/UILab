...
<main class="ui-container ui-no-gutter">
    ...
    <div class="ui-col-static ui-sm-fluid">
        ...
        <div class="dashboard-menu ui-col-250 ui-set-relative ui-visible-lg ui-theme-base ui-ease-width ui-ease-in-out">
            <div class="ui-col-250 ui-full-h ui-set-fixed ui-set-l ui-set-t ui-invert-bg ui-fill-dark-100 ui-ease-layout ui-ease-in-out">
                ...
                <div class="ui-set-relative ui-p-5-t">
                    <img class="ui-m-1-t" src="../public/img/logo-udashboard.png" height="62" alt="">
                ...
                <div class="ui-tab-holder ui-tab-accordion ui-align-l ui-icons-no-opacity ui-theme-sub ui-ease-tab ui-ease-1st-btn ui-scroll-v ui-scrollbar-faded ui-sidebar-add-l" data-ui-classes="ui-text">
                    ...
                    <a href="#" class="ui-btn ui-btn-lg ui-btn-ghost ui-block ui-m-10-v">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#grid-masonry"/></svg>
                        Dashboard
                    </a>

                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#users"/></svg>
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#moneys"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Payments
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#calendar-check"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Events
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#files"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Documents
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#chart-line"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Statistics
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#doc"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Reports
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <button class="ui-tab ui-tab-toggle ui-btn ui-btn-lg ui-btn-ghost ui-p-10-r ui-block">
                        <svg class="ui-icon ui-m-15-r"><use href="../dist/icons.svg#truck"/></svg>
                        <svg class="ui-toggle-icon ui-icon ui-float-r"><use href="../dist/icons.svg#angle-down"/></svg>
                        Orders
                    </button>
                    <div class="ui-tab-content">
                    ...
                    <div class="ui-btn-list ui-m-10 ui-icons-m-10-r ui-form-lg ui-ease-1st-btn">
                        <button class="ui-btn ui-round">
                            <svg class="ui-icon"><use href="../dist/icons.svg#shield"/></svg>
                            Administration
                        </button>
                        <button class="ui-btn ui-round">
                            <svg class="ui-icon"><use href="../dist/icons.svg#clock"/></svg>
                            Recent History
                        </button>
                        <button class="ui-btn ui-round">
        ...
        <div class="ui-row">
            ...
            <header class="ui-header-sticky ui-col-12 ui-align-r ui-icons-no-opacity ui-shadow-sm ui-form-lg ui-ease-layout dashboard-menu-opened" data-ui-classes="ui-shadow-lg">
                ...
                <div class="ui-align-c ui-float-l ui-ease-1st-btn">
                    ...
                    <button class="ui-btn ui-color-black-25 ui-btn-ghost ui-p-10 ui-circle ui-sidebar-show-l ui-hidden-lg" data-ui-tooltip title="Show Menu" data-ui-only="desktop">
                        <svg class="ui-icon"><use href="../dist/icons.svg#bars-left"/></svg>
                    </button>
                ...
                <div class="ui-inline">
                    <div class="ui-dropdown ui-menu-l ui-ease-dropdown">
                        <button class="ui-btn ui-color-black-25 ui-btn-square ui-btn-ghost ui-circle">
                            <span class="ui-notifier ui-circle">
                                <svg class="ui-icon"><use href="../dist/icons.svg#comment"/></svg>
                            </span>
                        </button>
                            ...
                            <div class="ui-tab-holder ui-theme-sub ui-ease-tab" data-ui-classes="ui-border-lg ui-stroke ui-text">
                                ...
                                <div class="ui-btn-holder ui-color-black-25 ui-align-c ui-border-b ui-ease-1st-btn">
                                    ...
                                    <button class="ui-tab ui-btn ui-btn-ghost ui-round-t ui-border-b" title="History">
                                        <svg class="ui-icon"><use href="../dist/icons.svg#history"/></svg>
                                    </button>
                                </div>
                    ...
                    <div class="ui-dropdown ui-menu-l ui-ease-dropdown">
                        <button class="ui-btn ui-color-black-25 ui-btn-square ui-btn-ghost ui-circle">
                            <span class="ui-notifier ui-circle">
                                <svg class="ui-icon"><use href="../dist/icons.svg#bell"/></svg>
                            </span>
                        </button>
                        <div class="ui-dropdown-menu ui-round ui-shadow-lg ui-no-scroll">
                            <div class="ui-tab-holder ui-theme-sub ui-ease-tab" data-ui-classes="ui-border-lg ui-stroke ui-text">
                                ...
                                <div class="ui-btn-holder ui-color-black-25 ui-align-c ui-border-b ui-ease-1st-btn">
                                    ...
                                    <button class="ui-tab ui-btn ui-btn-ghost ui-round-t ui-border-b" title="Notes">
                                        <svg class="ui-icon"><use href="../dist/icons.svg#pencil-write"/></svg>
                                    </button>
                                    <button class="ui-tab ui-btn ui-btn-ghost ui-round-t ui-border-b" title="Started Jobs">
                                        <svg class="ui-icon"><use href="../dist/icons.svg#hourglass-start"/></svg>
                                    </button>
                                </div>
                                <div class="ui-tab-content ui-align-l ui-scroll-v ui-open ui-open-ease" style="max-height: 420px;">
                                    <ul class="ui-timeline ui-timeline-l ui-m-15-h ui-timeline-no-h-lines">
                ...
                <div class="ui-float-r ui-m-10-l ui-xs-no-m">
                    <span class="ui-dropdown ui-menu-l ui-m-5-l ui-float-r ui-ease-dropdown">
                        <button class="ui-btn ui-no-p ui-circle ui-hover-scale-more">
                            <img class="ui-avatar ui-avatar-sm ui-circle" src="../public/img/profile-image.jpg" alt="">
                        </button>
                        <ul class="ui-dropdown-menu ui-dropdown-has-grid ui-align-c ui-icons-lg ui-round ui-shadow-lg">
                            ...
                            <li>
                                <a href="#">
                                    <svg class="ui-icon"><use href="../dist/icons.svg#lock"/></svg>
                                    Lock Screen
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <svg class="ui-icon"><use href="../dist/icons.svg#key"/></svg>
                                    Change Password
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <svg class="ui-icon"><use href="../dist/icons.svg#setting"/></svg>
                                    Settings
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <svg class="ui-icon"><use href="../dist/icons.svg#sign-out"/></svg>
                                    Logout
                                </a>
                            </li>
                        </ul>
            ...
            <!-- layouts: start -->
            <div class="ui-fixed ui-fixed-xl ui-p-30-v">
                <div class="ui-row">
                                ...
                                <div class="ui-carousel-content ui-p-10-h ui-p-10-t ui-p-15-b ui-theme-yellow">
                                    <div class="ui-card ui-full-h ui-p-15 ui-round ui-shadow-lg">
                                        ...
                                        <p class="ui-color-black-25">
                                            <svg class="ui-icon ui-icon-xs"><use href="../dist/icons.svg#clock"/></svg>
                        ...
                        <div class="ui-card ui-full-h ui-p-15 ui-round ui-shadow-lg">
                            <div class="ui-dropdown ui-menu-l ui-float-r ui-ease-dropdown">
                                <button class="ui-btn ui-btn-square ui-btn-ghost ui-round">
                                    <svg class="ui-icon"><use href="../dist/icons.svg#ellipsis-h"/></svg>
                                </button>
                                <ul class="ui-dropdown-menu ui-dropdown-has-icon ui-round ui-shadow-lg">
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-pdf"/></svg>Download PDF</a></li>
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-xls"/></svg>Download Excel</a></li>
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#eye"/></svg>See Detailed Activity</a></li>
                                </ul>
                            </div>
                            ...
                            <p class="ui-color-black-25">
                                <svg class="ui-icon ui-icon-xs ui-m-5-r"><use href="../dist/icons.svg#clock"/></svg>
                                <span class="ui-inline-block">Last updated: 15:12</span>
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="ui-ease-tab">
                                <div class="ui-dropdown ui-menu-l ui-float-r ui-ease-dropdown">
                                    ...
                                    <ul class="ui-dropdown-menu ui-dropdown-has-icon ui-round ui-shadow-lg">
                                        <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-pdf"/></svg>Download PDF</a></li>
                                        <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-xls"/></svg>Download Excel</a></li>
                                        <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#eye"/></svg>See Detailed Statistics</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="ui-col-xl-3 ui-col-lg-6 ui-col-12 ui-col-md-6">
                        <div class="ui-card ui-full-h ui-p-15 ui-p-10-t ui-round ui-shadow-lg" style="min-height: 350px;">
                            <div class="ui-tab-holder ui-form-lg ui-theme-sub ui-ease-tab" data-ui-classes="ui-border-lg ui-stroke ui-text">
                                ...
                                <div class="ui-tab-content ui-set-absolute ui-set-h ui-scroll-v ui-open ui-open-ease" style="top: 59px; bottom: 15px;">
                                    <ul class="ui-timeline ui-timeline-l ui-m-15-h ui-timeline-no-h-lines">
                                        <li>Etiam bibendum molestie lectus sit amet aliquet. Pellentesque non lacus iaculis, tristique velit.</li>
                                        <li>
                                            <span class="ui-avatar-holder ui-circle ui-hover-scale-more-2nd ui-ease-2nd-layout">
                                                <a href="#"><img class="ui-avatar ui-border-dual ui-circle" src="../public/img/profile-image.jpg" alt=""></a>
                                                <a href="#"><img class="ui-avatar ui-border-dual ui-circle" src="../public/img/profile-image2.jpg" alt=""></a>
                                                <a href="#"><img class="ui-avatar ui-border-dual ui-circle" src="../public/img/profile-image3.jpg" alt=""></a>
                                                <a class="ui-btn ui-btn-square ui-m-5-r ui-circle ui-ease-btn" href="#">+3</a>
                                            </span>
                                        </li>
                                        <li>
                                            <span class="ui-gallery ui-m-5-t ui-ease-gallery">
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_01.jpg"><img src="../public/img/image_01.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_02.jpg"><img src="../public/img/image_02.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_03.jpg"><img src="../public/img/image_03.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_04.jpg"><img src="../public/img/image_04.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_05.jpg"><img src="../public/img/image_05.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_06.jpg"><img src="../public/img/image_06.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_07.jpg"><img src="../public/img/image_07.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_08.jpg"><img src="../public/img/image_08.jpg" height="38" alt=""></a>
                                                <a class="ui-photo ui-m-1-h ui-round" href="../public/img/image_09.jpg"><img src="../public/img/image_09.jpg" height="38" alt=""></a>
                                            </span>
                                        </li>
                                        <li>Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</li>
                                        <li>Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</li>
                                        <li>
                                            <span class="ui-icons-xl ui-icons-no-opacity ui-ease-1st-btn">
                                                <a class="ui-btn ui-btn-square ui-p-5-v ui-round" href="#">
                                                    <svg class="ui-icon ui-m-2-v"><use href="../dist/icons.svg#file-pdf"/></svg>
                                                </a>
                                                <a class="ui-btn ui-btn-square ui-p-5-v ui-round" href="#">
                                                    <svg class="ui-icon ui-m-2-v"><use href="../dist/icons.svg#file-xls"/></svg>
                                                </a>
                                                <a class="ui-btn ui-btn-square ui-p-5-v ui-round" href="#">
                                                    <svg class="ui-icon ui-m-2-v"><use href="../dist/icons.svg#file-zip"/></svg>
                                                </a>
                                            </span>
                                        </li>
                                        <li>Aenean id tellus eu felis fermentum semper. Morbi et erat tincidunt, molestie leo a, accumsan dui</li>
                                ...
                                <div class="ui-tab-content ui-set-absolute ui-set-h ui-scroll-v" style="top: 59px; bottom: 15px;">
                                    <ul class="ui-timeline ui-timeline-l ui-m-15-h ui-timeline-no-h-lines">
                                        <li>Nullam sit amet sagittis nisi. Phasellus libero dolor, aliquam eu erat sed.</li>
                                        <li>Aenean id tellus eu felis fermentum semper. Morbi et erat tincidunt, molestie leo a, accumsan dui</li>
                                        <li>Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</li>
                    ...
                    <div class="ui-col-xl-3 ui-col-lg-6 ui-col-12 ui-col-md-6">
                        <div class="ui-card ui-full-h ui-p-15 ui-round ui-shadow-lg">
                            <div class="ui-dropdown ui-menu-l ui-float-r ui-ease-dropdown">
                                ...
                                <ul class="ui-dropdown-menu ui-dropdown-has-icon ui-round ui-shadow-lg">
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#calendar-plus"/></svg>Add to Your Calendar</a></li>
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#eye"/></svg>See All Events</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="ui-card ui-full-h ui-p-15 ui-round ui-shadow-lg">
                            <div class="ui-dropdown ui-menu-l ui-float-r ui-ease-dropdown">
                                ...
                                <ul class="ui-dropdown-menu ui-dropdown-has-icon ui-round ui-shadow-lg">
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-pdf"/></svg>Download PDF</a></li>
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#file-xls"/></svg>Download Excel</a></li>
                                    <li><a href="#"><svg class="ui-menu-icon ui-icon"><use href="../dist/icons.svg#eye"/></svg>See All Experts</a></li>
                                </ul>
                            </div>
...
<div class="ui-sidebar ui-sidebar-l ui-round ui-invert-bg ui-theme-base ui-fill-dark-100 ui-ease-layout ui-ease-in-out">
    <div class="ui-sidebar-title ui-no-p ui-border-b">
        ...
        <img class="ui-m-10-t" src="../public/img/logo-udashboard.png" height="62" alt="">
    </div>
            ...
            <div class="ui-col-static ui-no-fluid">
                <div class="ui-row ui-no-row-gap-h">
                    <div class="ui-col-12 ui-ease-1st-form">
                        <div class="ui-input ui-form-has-clear ui-form-icon ui-round-l ui-no-border ui-shadow-in-sm ui-theme-gray ui-fill-light-300">
