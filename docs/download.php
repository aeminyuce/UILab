...
<main class="container">
    <div class="row">
        <div class="col-12">
            <div class="padding-30-v sm-no-padding tabs ui-theme-sub ui-ease-tabs" data-ui-classes="border-b border-lg ui-stroke">
                ...
                <div class="generate-holder tab-content form-lg padding-30 open open-ease">
                    ...
                    <div class="align-c margin-30-b">
                        <div class="file no-border round circle no-border ui-ease-form form-inline-xs">
                        ...
                        <div class="col-3 col-md-4 col-sm-6">
                            ...
                            <div class="generate-forms margin-20-b block-1st">
                                <label class="custom margin-5-b opacity ui-ease-opacity">
                                    <span class="switch-custom round border-dual ui-ease-form form-disabled">
                    ...
                    <div class="row">
                        <div class="col-12 no-padding-t">
                            ...
                            <div class="textarea margin-15-b round border-dual ui-ease-form">
