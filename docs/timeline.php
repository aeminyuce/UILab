        ...
        <div class="row">
            <div class="col-12 padding-30-v">
                ...
                <ul class="timeline hide-lines large theme-yellow">
                    <li class="ui-text"><span class="card xx-dark align-r">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="ui-text"><span class="card xx-dark">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                ...
                <ul class="timeline side-l large">
                    <li class="theme-yellow ui-text"><span class="card xx-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="theme-orange ui-text"><span class="card xx-dark">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                    <li class="theme-red ui-text"><span class="card xx-dark">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span></li>
                    <li class="theme-default ui-text"><span class="card xx-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="theme-default2 ui-text"><span class="card xx-dark">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
