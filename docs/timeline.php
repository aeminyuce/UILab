            ...
            <div class="ui-col-12 ui-padding-30-v">
                ...
                <ul class="ui-timeline ui-font-16 ui-theme-base ui-current">
                    ...
                    <li>
                        ...
                        <span class="ui-card ui-font-readable ui-round ui-fill-dark-100">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span>
                    </li>
                    <li>
                        <span class="ui-img-photo ui-circle ui-shadow-lg ui-theme-yellow ui-fill-dark-100"><span>HY</span></span>
                        <span class="ui-card ui-font-readable ui-round ui-fill-dark-100">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span>
                    </li>
                </ul>
                ...
                <ul class="ui-timeline ui-font-16 ui-theme-sub ui-current">
                    <li>
                        ...
                        <span class="ui-card ui-font-readable ui-border-dual ui-round ui-stroke ui-shadow-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span>
                    </li>
                    <li>
                        <span class="ui-img-photo-sm ui-circle ui-fill-dark-100">
                            <svg class="ui-icon ui-color-white"><use href="#heart"/></svg>
                        </span>
                        <span class="ui-card ui-font-readable ui-border-dual ui-round ui-stroke ui-shadow-lg">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span>
                    </li>
                    <li>
                        <span class="ui-img-photo-sm ui-circle ui-fill-dark-100">
                            <svg class="ui-icon ui-color-white"><use href="#flag"/></svg>
                        </span>
                        <span class="ui-card ui-font-readable ui-border-dual ui-round ui-stroke ui-shadow-lg">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span>
                    </li>
                </ul>

                <h3 class="ui-h3 ui-align-c">2016</h3>
                <ul class="ui-timeline large">
                    <li><span class="ui-card ui-font-readable ui-border-dual ui-border-dark ui-round">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li><span class="ui-card ui-font-readable ui-border-dual ui-border-dark ui-round">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                </ul>
                ...
                <ul class="ui-timeline ui-hide-lines large">
                    <li><span class="ui-card ui-font-readable ui-align-r">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li><span class="ui-card ui-font-readable">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                    <li><span class="ui-card ui-font-readable ui-align-r">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span></li>
                </ul>
                ...
                <ul class="ui-timeline ui-side-l large">
                    <li class="ui-theme-yellow ui-current"><span class="ui-card ui-font-readable ui-color-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="ui-theme-orange ui-current"><span class="ui-card ui-font-readable ui-color-black">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                    <li class="ui-theme-red ui-current"><span class="ui-card ui-font-readable ui-color-black">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span></li>
                    <li class="ui-theme-base ui-current"><span class="ui-card ui-font-readable ui-color-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="ui-theme-sub ui-current"><span class="ui-card ui-font-readable ui-color-black">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                    <li class="ui-theme-green ui-current"><span class="ui-card ui-font-readable ui-color-black">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span></li>
                </ul>
