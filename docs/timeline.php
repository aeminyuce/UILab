        ...
        <div class="row">
            <div class="col-12 padding-30-v">
                ...
                <ul class="ui-timeline ui-side-l large">
                    ...
                    <li class="ui-theme-base ui-color"><span class="ui-card font-color-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas nulla, et laoreet nulla. Vestibulum finibus nec metus vel bibendum. Mauris consectetur congue pellentesque. </span></li>
                    <li class="ui-theme-sub ui-color"><span class="ui-card font-color-black">Nullam sit amet sagittis nisi. Aenean imperdiet dolor nibh, a porta nunc maximus vitae.</span></li>
                    <li class="ui-theme-green ui-color"><span class="ui-card font-color-black">Etiam bibendum molestie lectus sit amet aliquet. In hac habitasse platea dictumst. Duis libero massa, dapibus sit amet leo malesuada, pharetra iaculis sapien. Pellentesque lobortis leo vitae magna sollicitudin, at tincidunt felis tempor.</span></li>
                </ul>
