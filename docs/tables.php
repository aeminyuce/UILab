        ...
        <div class="row">
            <div class="col-12 padding-30">
                ...
                <table class="table padding-30-b table-hover ease-table">
                    ...
                    <tbody>
                        <tr class="theme-gray ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-orange ui-bg-light-100 hover">
                            <th scope="row">2</th>
                            <td>Jacob</td>
                            <td>Thornton</td>
                            <td>@fat</td>
                        </tr>
                        <tr class="theme-red ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-yellow ui-bg-light-100 hover">
                            <th scope="row">2</th>
                            <td>Jacob</td>
                            <td>Thornton</td>
                            <td>@fat</td>
                        </tr>
                        <tr class="theme-green ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-default ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-default2 ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                ...
                <table class="table padding-30-b table-hover theme-red ease-table">
                    ...
                    <tbody>
                        <tr class="ui-bg-light-100 hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
