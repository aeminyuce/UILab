        ...
        <div class="row">
            <div class="col-12 padding-30">
                ...
                <div class="row padding-30-b">
                    <div class="col-6">
                        <table class="table padding-30-b table-border">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>First Name</th>
                    ...
                    <div class="col-6">
                        <table class="table padding-30-b table-border border">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>First Name</th>
                ...
                <table class="table padding-30-b table-hover ease-table">
                    ...
                    <tbody>
                        <tr class="theme-gray ui-x-light hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-orange ui-x-light hover">
                            <th scope="row">2</th>
                            <td>Jacob</td>
                            <td>Thornton</td>
                            <td>@fat</td>
                        </tr>
                        <tr class="theme-red ui-x-light hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-yellow ui-x-light hover">
                            <th scope="row">2</th>
                            <td>Jacob</td>
                            <td>Thornton</td>
                            <td>@fat</td>
                        </tr>
                        <tr class="theme-green ui-x-light hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-default ui-x-light hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
                        </tr>
                        <tr class="theme-default2 ui-x-light hover">
                            <th scope="row">1</th>
                            <td>Mark</td>
                            <td>Otto</td>
                            <td>@mdo</td>
