    ...
    <div class="ui-fixed ui-padding-30-v ui-theme-base">
        <div class="ui-row">
            ...
            <div class="ui-col-6 ui-no-padding-v">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open modal window with id.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open modal window with class name.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '.myModal'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '.myModal'});">Run Code</button>
            ...
            <div class="ui-col-6 ui-no-padding-v">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open large size modal window.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open default (medium) size modal window.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open small size modal window.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open fullscreen modal window.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open inline modal window.</i>
            ...
            <div class="ui-col-6 ui-no-padding-t">
                ...
                <i class="ui-color-black-50 ui-margin-5-b block">Open fixed size modal window.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '.myModal',<br>    size: '560x315'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '.myModal', size: '560x315'});">Run Code</button>
            ...
            <div class="ui-col-12">
                ...
                <b>Type:</b>
                <i class="ui-color-black-50 ui-margin-5-b block">Open links with ajax modal.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: 'xhr/ajax-modal.php'<br>    size: 'lg',<br>    type: 'ajax'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: 'xhr/ajax-modal.php', size: 'lg', type: 'ajax'});">Run Code</button>

                <span class="sp-15"></span>

                <i class="ui-color-black-50 ui-margin-5-b block">
                    Open links with iframe modal.<br>
                    Youtube embed link example:
                </i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: 'https://www.youtube.com/embed/Ct6BUPvE2sM',<br>    size: '640x360',<br>    type: 'iframe'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: 'https://www.youtube.com/embed/Ct6BUPvE2sM', size: '640x360', type: 'iframe'});">Run Code</button>

                <span class="sp-15"></span>

                <i class="ui-color-black-50 ui-margin-5-b block">Google map embed link example:</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d770809.0860158126!2d28.45174621544522!3d41.003964328513874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa7040068086b%3A0xe1ccfe98bc01b0d0!2zxLBzdGFuYnVs!5e0!3m2!1str!2str!4v1549286679927',<br>    size: 'fullscreen',<br>    type: 'iframe'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d770809.0860158126!2d28.45174621544522!3d41.003964328513874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa7040068086b%3A0xe1ccfe98bc01b0d0!2zxLBzdGFuYnVs!5e0!3m2!1str!2str!4v1549286679927', size: 'fullscreen', type: 'iframe'});">Run Code</button>

                <span class="sp-15"></span>

                <i class="ui-color-black-50 ui-margin-5-b block">Google map embed link with header and footer:</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '#myModal02'<br>    size: 'fullscreen'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '#myModalId02', size: 'fullscreen'});">Run Code</button>
            ...
            <div class="ui-col-12">
                ...
                <b>Bg:</b>
                <i class="ui-color-black-50 ui-margin-5-b block">Enable/Disable modal window background color.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '.search',<br>    bg: 'false'<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '.search', bg: 'false'});">Run Code</button>
            ...
            <div class="ui-col-12">
                ...
                <b>Closable:</b>
                <i class="ui-color-black-50 ui-margin-5-b block">Close modal window with footer buttons.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '.myModal',<br>    closable: false<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '.myModal', closable: false});">Run Code</button>
            ...
            <div class="ui-col-12">
                ...
                <b>Callback:</b>
                <i class="ui-color-black-50 ui-margin-5-b block">Callback call after open modal.</i>
                <pre class="round ui-margin-5-b">ui.modal.open({<br>    source: '.myModal',<br>    callback: function () {<br>        alert('Modal opened!');<br>    }<br>});</pre>
                <button class="ui-btn ui-btn-sm round ui-fill-dark-100 ui-ease-btn" onclick="ui.modal.open({source: '.myModal', callback: function () { alert('Modal opened!'); }});">Run Code</button>
            ...
            <div class="ui-col-12 ui-no-padding-b">
                ...
                <pre class="round ui-margin-5-b">ui.modal.close({<br>    function () {<br>        alert('Modal closed!');<br>    }<br>});</pre>
...
<div id="myModalId01" class="ui-modal myModal ui-theme-base">
    ...
    <div class="ui-modal-container large font-readable ui-padding-30">
        ...
        <img class="ui-img-fluid ui-margin-30-v round ui-auto-margin block shadow-lg" src="img/image_05.jpg" style="max-width: 700px" alt="">
...
<div id="myModalId02" class="ui-modal">
    ...
    <div class="ui-modal-footer">
        <div class="ui-modal-buttons ui-ease-1st-btn">
            <button type="submit" class="ui-btn ui-padding-30-h circle ui-theme-green ui-fill-dark-100" onclick="ui.modal.close();">Save</button>
        </div>
    </div>
</div>
...
<div class="search ui-modal form-lg">
    <div class="ui-modal-container ui-xs-no-padding">
        ...
        <form action="#successful">
            ...
            <div class="ui-row ui-xs-fluid ui-icons-xxl block-2nd ui-icons-no-opacity hover-t-more-2nd ui-icons-margin-5-v ui-theme-base form-lg ui-ease-2nd-btn">
