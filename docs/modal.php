    ...
    <div class="ui-fixed ui-padding-30-v ui-theme-base">
        <div class="ui-row">
            ...
            <div class="ui-col-12">
                ...
                <i class="font-color-black-50 ui-margin-5-b block">
                ...
                <i class="font-color-black-50 ui-margin-5-b block">Google map embed link example:</i>
                ...
                <i class="font-color-black-50 ui-margin-5-b block">Google map embed link with header and footer:</i>
